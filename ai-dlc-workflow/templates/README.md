...
- **`enhancement-request.md`** — copy to `/.ai-dlc/stories/<change-name>.md` for anything genuinely new or
...
- **`bug-request.md`** — copy to `/.ai-dlc/stories/<bug-name>.md` for the lightweight bug-fix variant. Claude
