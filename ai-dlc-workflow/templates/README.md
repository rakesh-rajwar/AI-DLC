...
- **`enhancement-request.md`** — copy to `/.ai-dlc/<change-name>.md` for anything genuinely new or
  ...
  tasks) — directly into `/.ai-dlc/baseline/stories.md`, tagged `Status: Not Started | In Progress |
...
- **`bug-request.md`** — copy to `/.ai-dlc/<bug-name>.md` for the lightweight bug-fix variant. Claude
...
Both assume `/.ai-dlc/baseline/` already exists and has been accepted — see `ai-dlc-workflow/brownfield/`
