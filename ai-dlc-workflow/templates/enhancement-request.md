...
Single intake file — copy to `/.ai-dlc/<change-name>.md`. This is all you write by hand; Claude analyzes
it and drafts the story (or stories) directly into `/.ai-dlc/baseline/stories.md` — see
...
`/.ai-dlc/baseline/stories.md` drafted from this request, title + status, e.g.:
