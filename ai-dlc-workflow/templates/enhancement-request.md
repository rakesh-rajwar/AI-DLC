...
Single intake file — copy to `/specs/<change-name>.md`. This is all you write by hand; Claude analyzes
it and drafts the story (or stories) directly into `/specs/baseline/stories.md` — see
...
`/specs/baseline/stories.md` drafted from this request, title + status, e.g.:
